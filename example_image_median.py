...
year = "20"
file_name = "sub-gl108"
img_nib = nib.load(f"./nnUNet_raw/Dataset101_VerSe2020/imagesTs/{file_name}_0000.nii.gz")
msk_nib = nib.load(f"./nnUNet_predicted/Dataset{dataset}/{file_name}.nii.gz")
# msk_nib = nib.load(f"../01_data/02_VerseNewData/dataset-verse{year}test/dataset-03test/derivatives/{file_name}/{file_name}_dir-ax_seg-vert_msk.nii.gz")
...
print(img_nib.get_fdata().shape)
print(img_iso.get_fdata().shape)
...
plt.savefig(f'./{file_name}_ours_300.png')
